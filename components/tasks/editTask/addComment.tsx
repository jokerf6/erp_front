...
export default function AddComment(props: { setAddComment: any }) {
  ...
  return (
    ...
    <div className="absolute top-0 left-0 right-0 bottom-0 z-[21] bg-black/20 flex justify-center ">
      <div onClick={(e) => e.stopPropagation()} className="flex flex-col gap-[10px] px-[20px] py-[15px] w-[350px] h-fit bg-white rounded-lg">
