...
export default function MinimizedMeeting() {
  ...
  return (
    <div className="minimized-meeting absolute z-[3] bottom-3 left-3 bg-[linear-gradient(270deg,#F7F7F7_1.42%,#F0E8FF_100%)] border border-[#E0CEFF] drop-shadow-[-2px_2px_8px_0px_rgba(37,27,55,0.03)] text-[20px] text-white flex gap-[20px] items-center rounded-[30px] px-[15px] py-[10px]">
      <div className="flex gap-[16px] items-center">
        <ProfilePicture border={false} size={51} src={"/images/man.png"} />
